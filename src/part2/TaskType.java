...
public enum TaskType {
    COMPUTATIONAL(1){
        @Override
        public String toString(){return "Computational part2.Task";}
    },
    IO(2){
        @Override
        public String toString(){return "IO-Bound part2.Task";}
    },
    OTHER(3){
        @Override
        public String toString(){return "Unknown part2.Task";}
    };
